...
#	set structure_num 0
	...
	set packmol_userguide "this is guide"
...
#	grid rowconfigure $packmol.all.second 4 -weight 2
	...
	label $packmol.all.first.general.tol_constrain.out_bad_print.fra.checkbox.label -text "loading output structure:"
...
#	grid $packmol.all.first.sel.sit_list.add_del.geonumber.label $packmol.all.first.sel.sit_list.add_del.geonumber.spinbox -sticky e
	...
	frame $packmol.all.first.sel.up_down.shape_label.shape
	label $packmol.all.first.sel.up_down.shape_label.shape.label -text "show shape:"
	frame $packmol.all.first.sel.up_down.shape_label.shape.radiobutton
	radiobutton $packmol.all.first.sel.up_down.shape_label.shape.radiobutton.yes -text yes -variable ::packmol::draw_shape -value "yes" -state normal -command {::packmol::select_draw_shape}
	radiobutton $packmol.all.first.sel.up_down.shape_label.shape.radiobutton.no -text no -variable ::packmol::draw_shape -value "no" -state normal -command {::packmol::select_draw_shape}
	grid $packmol.all.first.sel.up_down.shape_label.shape.radiobutton.yes $packmol.all.first.sel.up_down.shape_label.shape.radiobutton.no
	grid $packmol.all.first.sel.up_down.shape_label.shape.label $packmol.all.first.sel.up_down.shape_label.shape.radiobutton

	frame $packmol.all.first.sel.up_down.shape_label.label
	label $packmol.all.first.sel.up_down.shape_label.label.label -text "show label:"
	frame $packmol.all.first.sel.up_down.shape_label.label.radiobutton
	radiobutton $packmol.all.first.sel.up_down.shape_label.label.radiobutton.yes -text yes -variable ::packmol::draw_label -value "yes" -state normal -command {::packmol::select_draw_label}
	radiobutton $packmol.all.first.sel.up_down.shape_label.label.radiobutton.no -text no -variable ::packmol::draw_label -value "no" -state normal -command {::packmol::select_draw_label}
	grid $packmol.all.first.sel.up_down.shape_label.label.radiobutton.yes $packmol.all.first.sel.up_down.shape_label.label.radiobutton.no
	grid $packmol.all.first.sel.up_down.shape_label.label.label $packmol.all.first.sel.up_down.shape_label.label.radiobutton

	pack $packmol.all.first.sel.up_down.shape_label.shape $packmol.all.first.sel.up_down.shape_label.label -side left -fill both -expand 1
...
#	pack $packmol.all.first.system.system_fra -side left -fill both -expand 1
	...
	$packmol.all add $packmol.all.second -text "User Guides" -sticky news
	...
	$packmol.all.second.guide.notebook.notebook.framework.text insert 1.0 $packmol_userguide
	...
	pack $packmol.all.second.guide.notebook.notebook.framework -fill both
...
#				::packmol::refresh_filelist
				...
				set nvmax_each [format "%.2f" $nvmax_each_f]
...
#                               ::packmol::refresh_filelist
				...
				set nsmax_each [format "%.2f" $nsmax_each_f]
...
proc ::packmol::change_graphic_info {} {
	...
	if {$change_which_graphic=="cube"} {
		if {$need_to_reset==1} {
			set graphic_info_single_update {0 0 0 0 0 1 0}
			set cube_start_x 0
			set cube_start_y 0
			set cube_start_z 0
			set cube_size 0
	...
	if {$draw_label == "yes"} {
		...
		while {$number_fir < $res_moleculelist_len} {
			...
			if {$each_graphic == 6} {
				...
				set cube_label [graphics $res_id text $cube_start_list "($each_cube_start_x, $each_cube_start_y, $each_cube_start_z)"]
				lappend cube_label_list $cube_label

				set cube_label [graphics $res_id point $cube_end_list]
				lappend cube_label_list $cube_label
				set cube_label [graphics $res_id text $cube_end_list "($each_cube_end_x, $each_cube_end_y, $each_cube_end_z)"]
				lappend cube_label_list $cube_label
			...
			if {$each_graphic == 0} {
				...
				set box_label [graphics $res_id text $box_start_list "($each_box_start_x, $each_box_start_y, $each_box_start_z)"]
				lappend box_label_list $box_label

				set box_label [graphics $res_id point $box_end_list]
				lappend box_label_list $box_label
				set box_label [graphics $res_id text $box_end_list "($each_box_end_x, $each_box_end_y, $each_box_end_z)"]
				lappend box_label_list $box_label
			...
			if {$each_graphic == 1} {
				...
				set sphere_label [graphics $res_id text $sphere_center_list "($each_sphere_x, $each_sphere_y, $each_sphere_z)"]
				lappend sphere_label_list $sphere_label
				...
				set sphere_label [graphics $res_id text $sphere_surface_list "$number_fir"]
				lappend sphere_label_list $sphere_label
			...
			if {$each_graphic == 2} {
				...
				set ellipsoid_label [graphics $res_id text $ellipsoid_center_list "($each_ellipsoid_a1, $each_ellipsoid_b1, $each_ellipsoid_c1)"]
				lappend ellipsoid_label_list $ellipsoid_label
			...
			if {$each_graphic == 3} {
				...
				set plane_label [graphics $res_id text $plane_center_list "($each_plane_center_x, $each_plane_center_y, $each_plane_center_z)"]
				lappend plane_label_list $plane_label
			...
			if {$each_graphic == 4} {
				...
				set cylinder_label [graphics $res_id text $cylinder_center_fir_list "($each_cylinder_fir_circle_x, $each_cylinder_fir_circle_y, $each_cylinder_fir_circle_z)"]
				lappend cylinder_label_list $cylinder_label
				...
				set cylinder_label [graphics $res_id text $cylinder_center_sec_list "($each_cylinder_sec_circle_x, $each_cylinder_sec_circle_y, $each_cylinder_sec_circle_z)"]
				lappend cylinder_label_list $cylinder_label
...
proc ::packmol::draw_cube_label {} {
	...
	set cube_label_list {}
        ...
        set cube_label [graphics $res_id point $cube_start_list]
        lappend cube_label_list $cube_label
        set cube_label [graphics $res_id text $cube_start_list "($cube_start_x, $cube_start_y, $cube_start_z)"]
        lappend cube_label_list $cube_label

        set cube_label [graphics $res_id point $cube_end_list]
        lappend cube_label_list $cube_label
        set cube_label [graphics $res_id text $cube_end_list "($cube_end_x, $cube_end_y, $cube_end_z)"]
        lappend cube_label_list $cube_label
...
proc ::packmol::draw_box_label {} {
	...
	set box_label [graphics $res_id point $box_start_list]
	lappend box_label_list $box_label
	set box_label [graphics $res_id text $box_start_list "($box_start_x, $box_start_y, $box_start_z)"]
	lappend box_label_list $box_label

	set box_label [graphics $res_id point $box_end_list]
	lappend box_label_list $box_label
	set box_label [graphics $res_id text $box_end_list "($box_end_x, $box_end_y, $box_end_z)"]
	lappend box_label_list $box_label
...
proc ::packmol::draw_sphere_label {} {
	...
	set sphere_label [graphics $res_id text $sphere_center_list "($sphere_x, $sphere_y, $sphere_z)"]
	lappend sphere_label_list $sphere_label
	...
	set sphere_label [graphics $res_id text $sphere_surface_list "Mol# $res_id"]
	lappend sphere_label_list $sphere_label
...
proc ::packmol::draw_plane_label {} {
	...
	set color_list [split $plane_color " "]
        ...
        set plane_label [graphics $res_id text $plane_center_list "($plane_center_x, $plane_center_y, $plane_center_z)"]
        lappend plane_label_list $plane_label
...
proc ::packmol::draw_cylinder_label {} {
	...
	set color_list [split $cylinder_color " "]
        ...
        set cylinder_label [graphics $res_id text $cylinder_center_fir_list "($cylinder_fir_circle_x, $cylinder_fir_circle_y, $cylinder_fir_circle_z)"]
        lappend cylinder_label_list $cylinder_label
	...
	set cylinder_center_sec_list {}
        ...
        set cylinder_label [graphics $res_id text $cylinder_center_sec_list "($cylinder_sec_circle_x_new, $cylinder_sec_circle_y_new, $cylinder_sec_circle_z_new)"]
        lappend cylinder_label_list $cylinder_label
...
proc ::packmol::draw_ellipsoid_label {} {
	...
	set color_list [split $ellipsoid_color " "]
        ...
        set ellipsoid_label [graphics $res_id text $ellipsoid_center_list "($ellipsoid_a1, $ellipsoid_b1, $ellipsoid_c1)"]
        lappend ellipsoid_label_list $ellipsoid_label
...
proc ::packmol::use_setted {} {
	...
	if {[catch {set f [open $vmd_packmol_json_pwd r]}]} {
		...
		if {[catch {set checkbox [dict get $dict_info "checkbox"]}]} {
			file delete $vmd_packmol_json_pwd
			::packmol::general_setting
			return
		}
